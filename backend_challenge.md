...
**AI tools are welcome.** We embrace AI as part of our daily development workflow, and we expect senior engineers to leverage these tools effectively.
...
* The provided solutions needs to be uploaded into a public repository (Github, Gitlab, bitbucket) with a README.MD providing the following information.
    ...
    * Requirements
* The company name must not be referenced in any place in your code.
